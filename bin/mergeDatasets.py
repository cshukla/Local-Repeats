...
#    
#    General recommendation: if you have 16+GB of RAM, and .sra (.fastq.gz) files 
#    were less than 30GB, then you should be fine with parsing things in memory. 
#
########################################################################################
            ...
            if parseInMemory == True:
                ...
                if True:
                    ...
                    TR = HiCdataset("bla" + str(np.random.randint(100000000000)), genome=getGenome(workingGenome),
                                    ...
                                    inMemory=False)  # remove inMemory if you don't have enough RAM
